...
describe("Dom Test", function() {
  ...
  beforeEach(function() {
    ...
    testContainer.innerHTML = "<form>" +
      "1.填空题：<br />" +
      "<input type='text' name='text-1-1' value='啊哈'/><br />" +
      "<input type='text' name='text-1-2' value='无哈'/><br />" +
      "<input type='text' name='text-1-2' value='哈哈'/><br />" +
      "<input type='text' name='text-1-2' value='呵呵'/><br />" +
      "2.单选题：<br />" +
  ...
  it("should return corrent tag name", function() {
    ...
    var result = theFormAnalyser.formSerializer(form);
      expect(result).toEuqal([
        ...
        {name:"test-5-1",type:"text",value:"你是不是不好"}]
      );
  });
});
